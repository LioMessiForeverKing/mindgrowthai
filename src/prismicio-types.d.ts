...
export interface IntegrationsSliceDefaultPrimaryRepeatableZoneItem {
	...
	icon: prismic.SelectField<
		'learning' | 'education' | 'knowledge' | 'accessibility' | 'growth' | 'happiness'
	>;
}
...
export interface IntegrationsSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#group
	 */
	repeatable_zone: prismic.GroupField<Simplify<IntegrationsSliceDefaultPrimaryRepeatableZoneItem>>;
}
...
export interface ShowcaseSliceDefaultPrimary {
	 ...
	 * - **Documentation**: https://prismic.io/docs/field#select
	 */
	icon: prismic.SelectField<'learn' | 'experiment' | 'understand' | 'knowledge'>;
