<script>
	...
	import MdiLightBookMultiple from '~icons/mdi-light/book-multiple'
	import SolarAtomBroken from '~icons/solar/atom-broken'
	...
	const icons = {
		experiment: IconGear,
		understand: IconCycle,
		knowledge: MdiLightBookMultiple,
		learn: SolarAtomBroken
	};
</script>

<Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation} class="relative">
	<div
		class="showcase__glow absolute -z-10 aspect-video w-full max-w-2xl rounded-full bg-red-500 mix-blend-screen blur-[120px] filter"
	/>
